        ...
        <div className="flex h-full flex-row gap-5 items-center w-1/3">
          ...
          <div className="flex flex-col h-full justify-start">
            <h2 className="text-2xl font-bold text-indigo-600">
              {jobDetail?.serialjobno} ({jobDetail?.designno})
            </h2>
            {/* <p className="text-lg font-semibold text-gray-700">{jobDetail.serialFor}</p> */}
            <p className="text-sm text-gray-600 uppercase gap-3">{jobDetail?.metalpurity} {jobDetail?.MetalColor} {jobDetail?.metaltype}</p>
            <p className="text-sm text-gray-500">{jobDetail?.Locationname}</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 gap-x-8 gap-y-2 w-2/3">
          <div className="flex flex-col">
            <div className="flex items-center  gap-2">
              ...
              <p className="text-xl  font-medium text-indigo-700 capitalize">{jobDetail?.CustomerName} ({jobDetail?.PO})</p>
            </div>

            <div className="mt-2">
              <p className="text-sm text-gray-500">Add In Gross Wt:
                <strong className="text-lg font-medium   text-gray-700"> ({jobDetail?.ismisc_not_addingrosswt == 0 ? "NO" : "YES"})</strong>
              </p>
            </div>
            <div className="mt-2">
              <p className="text-sm text-gray-500">HMW:
                <strong className="text-lg font-medium   text-gray-700"> ({jobDetail?.iddhadijob == 0 ? "NO" : "YES"})</strong>
              </p>
            </div>
          </div>
